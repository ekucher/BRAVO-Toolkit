...
developer: 5.2.0-rc.13 (prerelease; acceptance ще не пройдено —
...
- `v5.2.0-rc.13` (rc.12 + PR #98: підетапи у прогресі тривалих
  ...
  проєкту моделі) — **фінальний кандидат циклу; acceptance ще не
  пройдено**; накопичена нова поверхня rc.9-rc.13 вимагає повного
