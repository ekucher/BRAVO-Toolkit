@{
    ...
    FunctionsToExport = @('Get-BRAVOConfiguratorValueAtPath', 'Resolve-BRAVOConfiguratorSuppliedLeafOverride', 'Convert-BRAVOConfiguratorNestedContainerToFlatKeys', 'Get-BRAVOConfiguratorModel', 'Set-BRAVOConfiguratorOverride', 'Clear-BRAVOConfiguratorOverride', 'ConvertTo-BRAVOConfiguratorOverrideHashtable', 'Get-BRAVOConfiguratorSessionSchemaCatalog', 'Test-BRAVOConfiguratorValueEquality', 'Update-BRAVOConfiguratorEffective')
    VariablesToExport = @()
    CmdletsToExport = @()
    AliasesToExport = @()
}
