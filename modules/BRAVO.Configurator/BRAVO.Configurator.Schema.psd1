...
@{
    ...
    Descriptors = @(
        ...
        @{ Path = 'credentialSettings.Targets.OperationsBootstrapSecret'; Group = 'Credentials'; Section = 'Targets'; Label = 'Ім''я запису: BSYSTEM Operations bootstrap-секрет'; Description = 'Назва запису Windows Credential Manager (не сам секрет). Використовується лише для first-run self-enrollment.'; Type = 'String'; Phase = 1; Advanced = $true; ReadOnly = $false; Secret = $false; Order = 70 }
        @{ Path = 'credentialSettings.Targets.OperationsApiKey'; Group = 'Credentials'; Section = 'Targets'; Label = 'Ім''я запису: BSYSTEM Operations API-ключ'; Description = 'Назва запису Windows Credential Manager (не сам секрет). Заповнюється автоматично після approve self-enrollment.'; Type = 'String'; Phase = 1; Advanced = $true; ReadOnly = $false; Secret = $false; Order = 80 }
        ...
        # ===== Явне визначення джерел (discoverySettings) — фаза 1 =====
        @{ Path = 'discoverySettings.BravoRoot'; Group = 'Paths'; Section = 'Discovery'; Label = 'BRAVO_ROOT (каталог bravo.exe)'; Description = 'Потрібно лише коли auto-discovery непридатний; порожнє = auto. Явне значення ніколи не замінюється автоматично знайденим.'; Type = 'Path'; Phase = 1; Advanced = $true; ReadOnly = $false; Secret = $false; Order = 10 }
        @{ Path = 'discoverySettings.WebRoot'; Group = 'Paths'; Section = 'Discovery'; Label = 'WEB_ROOT (корінь веб-інсталяції)'; Description = 'Потрібно лише коли auto-discovery непридатний; порожнє = auto. Явне значення ніколи не замінюється автоматично знайденим.'; Type = 'Path'; Phase = 1; Advanced = $true; ReadOnly = $false; Secret = $false; Order = 20 }
        @{ Path = 'discoverySettings.BravoIniPath'; Group = 'Paths'; Section = 'Discovery'; Label = 'Шлях до canonical bravo.ini'; Description = 'Лише якщо bravo.ini не за системним шляхом архітектури ОС; порожнє = auto.'; Type = 'Path'; Phase = 1; Advanced = $true; ReadOnly = $false; Secret = $false; Order = 30 }
        @{ Path = 'discoverySettings.Sources.MODEL'; Group = 'Paths'; Section = 'Discovery'; Label = 'Джерело MODEL'; Description = 'Потрібно лише коли auto-discovery непридатний; порожнє = auto. Явне значення ніколи не замінюється автоматично знайденим.'; Type = 'Path'; Phase = 1; Advanced = $true; ReadOnly = $false; Secret = $false; Order = 40 }
        @{ Path = 'discoverySettings.Sources.BLOG'; Group = 'Paths'; Section = 'Discovery'; Label = 'Джерело BLOG'; Description = 'Потрібно лише коли auto-discovery непридатний; порожнє = auto. Явне значення ніколи не замінюється автоматично знайденим.'; Type = 'Path'; Phase = 1; Advanced = $true; ReadOnly = $false; Secret = $false; Order = 50 }
        @{ Path = 'discoverySettings.Sources.BRAVOEXCH'; Group = 'Paths'; Section = 'Discovery'; Label = 'Джерело BRAVOEXCH'; Description = 'Потрібно лише коли auto-discovery непридатний; порожнє = auto. Явне значення ніколи не замінюється автоматично знайденим.'; Type = 'Path'; Phase = 1; Advanced = $true; ReadOnly = $false; Secret = $false; Order = 60 }
        @{ Path = 'discoverySettings.Sources.BAZA_APP'; Group = 'Paths'; Section = 'Discovery'; Label = 'Джерело BAZA_APP'; Description = 'Потрібно лише коли auto-discovery непридатний; порожнє = auto. Явне значення ніколи не замінюється автоматично знайденим.'; Type = 'Path'; Phase = 1; Advanced = $true; ReadOnly = $false; Secret = $false; Order = 70 }
        @{ Path = 'discoverySettings.Sources.BAZA_WWW'; Group = 'Paths'; Section = 'Discovery'; Label = 'Джерело BAZA_WWW'; Description = 'Потрібно лише коли auto-discovery непридатний; порожнє = auto. Явне значення ніколи не замінюється автоматично знайденим.'; Type = 'Path'; Phase = 1; Advanced = $true; ReadOnly = $false; Secret = $false; Order = 80 }
        @{ Path = 'discoverySettings.Sources.BACKUP_ROOT'; Group = 'Paths'; Section = 'Discovery'; Label = 'Джерело BACKUP_ROOT (діагностичне)'; Description = 'НЕ визначає каталог призначення бекапів — він задається лише pathSettings.BackupRoot.'; Type = 'Path'; Phase = 1; Advanced = $true; ReadOnly = $false; Secret = $false; Order = 90 }
        ...
        # ===== Operations (operationsReportingSettings) — BSYSTEM Operations fleet-моніторинг, фаза 2 =====
